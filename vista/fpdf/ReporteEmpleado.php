...
$consulta_reporte_empleado = $conexion->query(" SELECT e.nombre, e.apellido, e.dni, c.nombre as 'nomCargo' from empleado AS e JOIN cargo AS c ON e.cargo = c.id_cargo ");
